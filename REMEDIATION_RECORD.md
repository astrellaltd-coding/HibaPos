...
*Moved verbatim from `REMEDIATION_PLAN.md` lines 1520–1562 (commit `PLACEHOLDER_SHA`) on 2026-09-08.*

### Status record

**Status:** `COMPLETED` · **Completed:** 2026-09-08 · **Commit:** `PLACEHOLDER_SHA` · **Findings:** L-67 (**closed**) · **Decisions:** none — the rule was already the repair script's and is reused rather than chosen.
...
|---|---|---|---|---|
| **5.8** | `COMPLETED` | 2026-09-08 | `PLACEHOLDER_SHA` | L-67: the catalogue editor was writing every inherited option group back onto the product on each save, so the POS showed each one twice; the rule now lives in one tested module and `PUT` refuses the duplicates. |
