...
**Current Stage:** **Stage 5 is IN PROGRESS** — **5.1, 5.2 and 5.3 COMPLETED 2026-09-05**. **Stage 4 is COMPLETED** (4.1 through 4.4, 4.4b, 4.4c, 4.5, 4.6 and 4.7, all 2026-09-04). **Stage 3 is back to IN PROGRESS** — eleven of twelve batches done, and **3.6c** added 2026-09-05 on an answered decision (L-27: the close guard checks a caisse's opening date, so a long-lived open caisse blocks no close at all). It must land before Batch 8.0. C-22's chain-design half stays carried forward as `REQUIRES EXTERNAL VERIFICATION`, and V-03 is open. Stage 1 is **partly done**: 1.1 and 1.2 COMPLETED, 1.3 `IMPLEMENTED — TESTING REQUIRED` on hardware, 1.4 deferred. Stage 2 is COMPLETED.
...
**Status:** `NOT STARTED` — added 2026-09-05, on the answer to L-27. **Must land before Batch 8.0.**

### L-27 — A caisse opened before the period never blocks that period's close

**Status:** `NOT STARTED` · Severity: LOW→MEDIUM · Category: data integrity (fiscal)
