...
| ~~**`Menu XXL`: the second pizza is imposed as Senior, not Mega**~~ **✅ DONE 2026-09-09**, by the operator within the hour. Re-measured read-only: both pizza slots now impose **Mega**. The catalogue matches the specification for all six menus. Why it was wrong and what it cost: record → *Batch 5.9 → Appended 2026-09-09*. | 5.9g |
